...
Rewritten and maintained by Mars Cheng

Originally written for Chicago Ruby by Ginny Hendry and Nola Stowe

Based on http://github.com/edgecase/ruby_koans

Requires: 	
* Ruby 1.8.7 or later
* RubyGems 1.5.3 or later
* Rake (any version)
* MongoDB 1.6.5 or later
* gem install mongo (1.2.4 or later)
* gem install bson (1.2.4 or later)
...
To run:
* Download source
  git clone git://github.com/kidrane/MongoDB_Koans.git
* cd to that directory
* rake
* Edit program file that reported an error
* Fix one error only!  and think about what you learned
* and run rake again 
